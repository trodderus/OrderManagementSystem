...
namespace OrderManagementSystem.Application.Tests.Entities.Orders.Commands
{
    public class CreateOrderValidatorTests
    {
        ...
        {
            var model = new CreateOrderCommand(new() { new(0, 2) });
        ...
        {
            var model = new CreateOrderCommand(new() { new(-1, 2) });
        ...
        {
            var model = new CreateOrderCommand(new() { new(3, 0) });
        ...
        {
            var model = new CreateOrderCommand(new() { new(3, 2) });
